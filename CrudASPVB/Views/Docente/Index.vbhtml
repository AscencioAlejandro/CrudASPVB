@ModelType List(Of CrudASPVB.Docente)
@Imports System.Data
@Code
    ViewData("Title") = "Index"
    Dim dataDocente As List(Of Docente) = Model
End Code
    ...
    <dl class="dl-horizontal">
        ...
        <div class="bs-example" data-example-id="bordered-table">
            <table class="table-futurista ">
                ...
                <tbody>
                    @For Each val As Docente In dataDocente
                        @<tr>
                            <td>@val.nombre</td>
                            <td>@val.apellido</td>
                            <td>
                                <a class="btn btn-primary text-white" href="@Url.Action("Editar", New With {.id = val.id_docente})">Editar</a>
                                <a class="btn btn-danger text-white" href="@Url.Action("Eliminar", New With {.id = val.id_docente})">Eliminar</a>
                            </td>
                        </tr>
                    Next
